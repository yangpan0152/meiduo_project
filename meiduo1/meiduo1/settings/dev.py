...
SECRET_KEY = '6l4d&#m%!1p=)tasd=pq%*#g#0^#40v$2-ru^(%ay4or@w(jl2'
...
DATABASES = {
    'default': {
        ...
        'PORT': 3306, # 数据库端口
        'USER': 'yangpan', # 数据库用户名
        'PASSWORD': '9527', # 数据库用户密码
        'NAME': 'meiduo_sy26',# 数据库名字
    },
}
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, 'logs/meiduo.logs'),  # 日志文件的位置
